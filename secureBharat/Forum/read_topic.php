...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Your messages(<?php echo $nb_new_pm; ?>)</a> - <a href="../myprofile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
    <div class="clean"></div>
</div>
<?php
...
<div class="box" style="margin-top:10px, padding:10px;">
	<div class="box_left" style="margin-top:10px, padding-top:10px;">
    	<a href="<?php echo $url_home; ?>">Forum Index</a> &gt; <a href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Read the topic
    </div>
	<div class="box_right" style="margin-top:10px, padding-top:10px;">
...
$dn2 = mysqli_query($conn,'select t.id2, t.authorid, t.message, t.timestamp, u.username as author  from topics as t, users as u where t.id="'.$id.'" and u.id=t.authorid order by t.timestamp asc') or die("".$conn);
?>
<table class="messages_table" style="margin-top:10px; padding-top:10px;">
	<tr style="margin-top:10px; padding-top:10px;">
    	<th class="author" style="margin-top:10px; padding-top:10px;">Author</th>
    	<th style="margin-top:10px; padding-top:10px;">Message</th>
	</tr>
<?php
