...
{
?>
	<a href="new_topic.php?parent=<?php echo $id; ?>" class="button">New Post</a>
<?php
}
...
?>
	<tr style="margin-top:10px, padding-left:10px;">
    	<td  style="padding-top:10px; margin-right:150px;"><a href="read_topic.php?id=<?php echo $dnn2['id']; ?>"><?php echo htmlentities($dnn2['title'], ENT_QUOTES, 'UTF-8'); ?></a></td>
    	<td style="padding-right:15px; vertical-align: text-top;"><?php echo htmlentities($dnn2['author'], ENT_QUOTES, 'UTF-8'); ?></td>
    	<td style="padding-left:15px; vertical-align: text-top;"><?php echo $dnn2['replies']; ?></td>
<?php
if(isset($_SESSION['username']) and $_SESSION['username']==$admin)
{
?>
    	<td style="vertical-align: text-top;"><a href="delete_topic.php?id=<?php echo $dnn2['id']; ?>"><img src="<?php echo $design; ?>/images/delete.png" alt="Delete" /></a></td>
<?php
}
?>
    </tr>
...
{
?>
<div class="message">This category has no Post.</div>
<?php
}
if(isset($_SESSION['username']))
{
?>
	<!--<a href="new_topic.php?parent=<?php echo $id; ?>" class="button">New Query</a>--!>
<?php
}
else
{
