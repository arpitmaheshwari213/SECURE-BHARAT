...
if($fetch_user_details['user_challenge_no']==4)
                {
						if(isset($_GET['hacker']))
				{
					...
					if($hacker==1)
					{
						echo "Username : Nobita<br> Password : shizuka";		
					}	
					if($hacker<5 && $hacker!=1){
						echo "Get Lost Dhakkan!"; 
					}
					if($hacker==5)
					{
						echo "Username : Angelina<br> Password : I-Kill-You";		
					}
            ...
            <div class="panel-heading">
              ...
              <div class="panel-body" style="background-color:black">
                ...
                <div class="col-md-3 col-sm-12" style="text-align:center;">
                  ...
                  <h4 style="font-family:'Josefin Slab',sans-serif;color:lime;"><?php echo $fetch_main_details['username'];?></h4>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-4" style="text-align:center;">
                  <img src="images/trophy_icon.png" class="icons" />
                  <h4 style="font-family:'Josefin Slab',sans-serif;color:lime;">Challenge :- <?php echo $fetch_user_details['user_challenge_no'];?></h4>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-4" style="text-align:center;">
                  <img src="images/coin_icon.jpg" class="icons" />
                  <h4 style="font-family:'Josefin Slab',sans-serif;color:lime;">Bit Coins :- <?php echo $fetch_user_details['user_bitcoin'];?> ฿</h4>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-4" style="text-align:center;">
                ...
                <div id="frame" >
                  ...
                  <div class="col-md-2 col-sm-3 col-xs-5" >
                    ...
                    <h4 style="font-family:'Josefin Slab',sans-serif;color:lime;">Rewards :-<?php echo $fetch_task_details['task_reward'];?></h4>
                  </div>
                  <!-- Question  -->
					
                    <div  style="margin:auto;text-align:center;">
                      <h3 style="font-family:'Josefin Slab',sans-serif;color:#ff9933;line-height:2;font-size:18px;margin:0px 20px;">
                      Do you know,<br>
...
<br>						
 ...
 <div>
					  <h3 style="font-family:'Josefin Slab',sans-serif;color:white;line-height:2;font-size:18px;margin:0px 20px;"> 
...
<h3 style="font-family:'Josefin Slab',sans-serif;color:lime;line-height:2;font-size:18px;margin:0px 20px;">   
	<span style="color:red;">Qusestion :- </span>You have to go there and tell me the information
...
</h3>	<div style="font-size:24px">Dork - hacker <br/>Username - Angelina</div>
 <!--<img src="2a261e54-7234-49d9-9c89-cd5536c4baa8.jpg"/>-->
                        ...
                        <!--<h4 style="font-family:'Josefin Slab',sans-serif;color:lime;text-align:center">ANSWER</H4>-->
                          <form action="" method="POST" >
                            <input type="password" id="answer" placeholder="Password for this level" name="password" style="background-color:black;text-align: center;color:lime;">
                            <br>
