...
<div class="nav-side-menu">
    <div  class="brand"><a href="../index.php">Secure Bharat</a></div>
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
               ...
               <?php if($fetch['content']!='') { ?><li><a href="trivia.php?x=<?php echo $fetch['topic_id'];?>">Trivia</a></li><?php }?>
    ...
    <div class="col-sm-offset-3 col-sm-9" style="height:100%; background-color:#fff; margin-top:10%;">
		...
		<?php $sel="select * from sub_topic where course_id=1 and topic_id=".$_GET['x']; 
 		         $exe=mysqli_query($conn,$sel);
		       $fetch=mysqli_fetch_array($exe,MYSQLI_ASSOC);
		...
		<div class="topic" id="topic1">
            <h2><?php echo $fetch['topic_name'];?></h2>
            <div class="border">
