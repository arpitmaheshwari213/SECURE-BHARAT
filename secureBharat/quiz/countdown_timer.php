...
<div id="main">
    <header>
        <h1><a href="https://www.npmjs.com/package/countdowntimer" target="_blank" title="jquery countdownTimer Plugin">jquery countdownTimer Plugin</a>&nbsp;Demo</h1>
        <p><a href="http://github.com/harshen/jquery-countdownTimer/zipball/1.0.9" title="Download">Download</a></p>
...
&lt;link rel=&quot;stylesheet&quot; type=&quot;text/css&quot; href=&quot;jquery.countdownTimer.css&quot; /&gt;</pre>
    ...
    <h3><u>Reverse countdown till a specific future date from today.</u><br/>(for eg:- 2020/01/01 00:00:00)</h3>
    ...
    <h4>Settings:-</h4>
                            <pre >$(function(){
	$(&quot;#future_date&quot;).countdowntimer({
                dateAndTime : &quot;2020/01/01 00:00:00&quot;&sbquo;
                                size : &quot;lg&quot;&sbquo;
    ...
    <h4>Settings:-</h4>
                            <pre >$(function(){
	$(&quot;#given_date&quot;).countdowntimer({
                startDate : &quot;2016/10/01 00:00:00&quot;&sbquo; //set server date and time as &quot;&lt;?php echo date(&#39;Y/m/d H:i:s&#39;); ?&gt;&quot;.
                dateAndTime : &quot;2020/01/01 00:00:00&quot;&sbquo; //end date
		size : &quot;lg&quot;
	})&#59;
})&#59;</pre>
	...
	$(&quot;#hms_timer&quot;).countdowntimer({
                hours : 3&sbquo;
                                ...
                                seconds : 10&sbquo;
                                size : &quot;lg&quot;&sbquo;
                                pauseButton : &quot;pauseBtnhms&quot;&sbquo;
                                stopButton : &quot;stopBtnhms&quot;
	})&#59;
})&#59;</pre>
    <p>Hours can take positive values starting from 0. Minutes, Seconds takes values from 0 to 59. More information about Pause and Stop buttons is provided in <a href="#more" title="More Settings">More Settings</a>.</p>
    ...
    <h2 style="color :#0625BC; font-weight: bold;"><a id="more">More Settings</a></h2>
    <h3>timeSeparator</h3>
    ...
    <h3>pauseButton</h3>
    <p>The ID of the button which will Pause / Resume the timer. Provide ID in quotes.</p>
    <h3>stopButton</h3>
    <p>The ID of the button which will Stop / Start the timer. Provide ID in quotes.</p>
    <h3>beforeExpiryTime</h3>
    <p>The time before expiry when <b>beforeExpiryTimeFunction</b> needs to be called. Format:- &quot;DD:HH:MM:SS&quot;.</p>
    <h3>beforeExpiryTimeFunction</h3>
    <p>The name of the callback function that is invoked before the countdown reaches zero at a time set in <b>beforeExpiryTime</b>. Within the function this refers to the division that holds the widget. No parameters are passed in. Provide the name to this option without quotes.</p>
	...
	$(&quot;#more_options&quot;).countdowntimer({
                minutes : 20&sbquo;
                    ...
                    timeSeparator : &quot;-&quot;&sbquo;
                    timeUp : timeIsUp&sbquo;
                    expiryUrl : &quot;https://www.npmjs.com/package/countdowntimer&quot;&sbquo;
                    beforeExpiryTime : &quot;00:00:01:05&quot;&sbquo;
