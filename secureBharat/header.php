    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse navbar-default-collapse">
        <ul class="nav navbar-nav">
          ...
          <li <?php if(@$_GET['no']==5) {?> class="active" <?php } ?> ><a href="scavengerhunt/index.php?no=5">SCAVENGER HUNT</a></li>
          ...
          <li <?php if(@$_GET['no']==9) {?> class="active" <?php } ?>><a href="forum/index.php">Q&A FORUM</a></li>
        </ul>
